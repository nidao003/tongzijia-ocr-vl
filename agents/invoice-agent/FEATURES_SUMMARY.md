...
20260312_50000_12345678_C_阿里云.pdf
20260315_30000_98765432_E_腾讯云.jpg

格式说明：
- 金额(分)：整数，无小数点（1000.00元 → 100000）
- 发票号码：8位发票号
- 类型简称：S(专用)/C(普通)/E(电子)/Q(定额)
- 开票方简称：自动生成4-8字符简称
```
...
# 结果：
# 文件自动移动到: archive/2026/03/vat_special/
# 文件名自动改为: 20260311_100000_00534712_S_华为技术.png
```
